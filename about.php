    ...
    <section id="about">
        ...
        <div class="row">
            <div class="col-6">
                ...
                &emsp;&emsp;&emsp;<img src="./img/playstore.png" alt="" width="30%">&emsp;&emsp;&emsp;<img src="./img/app store.png" alt="" width="30%">
            </div>
            <div class="col-6">
                <img src="./img/mobile.png" alt="" width="40%" style="margin-left:30%"/>
            </div>
        </div>
    </section>
