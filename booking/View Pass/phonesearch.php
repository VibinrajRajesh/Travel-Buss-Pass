...
<div class="container">
    ...
    <form method="post" class="search-box">
        Search Your pass By Phone number:<br><input type="text"  name="id"placeholder="Enter Your Phone Number" class="search-input">
    ...
    if(isset($_POST['submit'])){
        ...
        $query = "Select * from booking where phoneno ='$id'";
